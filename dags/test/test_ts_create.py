...
def create_embedding():
    ...
    s3.download_file(
        local_path="/tmp/",preserve_file_name=True,use_autogenerated_subdir=False, key=f"{news_path}/kommersant_economics_2015_2024.csv", bucket_name="airflow"
    )
    s3.download_file(
        local_path="/tmp/", preserve_file_name=True,use_autogenerated_subdir=False,key=f"{news_path}/kommersant_financial_2015_2024.csv", bucket_name="airflow"
    )
    s3.download_file(
        local_path="/tmp/",preserve_file_name=True,use_autogenerated_subdir=False, key=f"{news_path}/kommersant_politics_2015_2024.csv", bucket_name="airflow"
    )


    economics_headlines = process_headlines('/tmp/kommersant_economics_2015_2024.csv')
    financial_headlines = process_headlines('/tmp/kommersant_financial_2015_2024.csv')
    politics_headlines = process_headlines('/tmp/kommersant_politics_2015_2024.csv')
